...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Tiempo Real',         icon: 'sensors',          route: '/seguimiento-tiempo-real', roles: ['ADMIN'] },
  { label: 'Novedades',           icon: 'report_problem',   route: '/novedades-sin-resolver',  roles: ['ADMIN'] },
...
export class LayoutComponent {
  ...
  readonly pageMeta: Record<string, { title: string; desc: string }> = {
    ...
    '/seguimiento-tiempo-real':  { title: 'Tiempo Real P3',          desc: 'Entregas activas con alertas de cumplimiento' },
    '/novedades-sin-resolver':   { title: 'Novedades Pendientes',    desc: 'Incidentes sin resolver con prioridad automática' },
